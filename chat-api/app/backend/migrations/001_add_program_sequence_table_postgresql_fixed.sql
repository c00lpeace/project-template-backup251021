...
-- Fixed: Added quotes to preserve case sensitivity
-- ============================================================================

-- 1. Drop existing table (if exists with wrong case)
DROP TABLE IF EXISTS program_sequence CASCADE;

-- 2. Create PROGRAM_SEQUENCE table with correct case
...
-- 4. Create trigger function for UPDATE_DT auto-update
...
-- Completion message
SELECT 'PROGRAM_SEQUENCE table created successfully with correct case!' AS Status;
